...
from wycode.teams.backend_detect import BackendDetectionError, detect_backend
from wycode.teams.mailbox import Mailbox, create_message
...
from wycode.teams.progress import TeammateProgress
from wycode.teams.registry import AgentNameRegistry
from wycode.teams.shared_task import SharedTaskStore
from wycode.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from wycode.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
