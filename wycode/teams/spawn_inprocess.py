...
from wycode.teams.progress import TeammateProgress, random_verb

if TYPE_CHECKING:
    from wycode.agent import Agent
    from wycode.conversation import ConversationManager
    from wycode.teams.models import TeammateInfo
    ...
    async def _run() -> str:
        ...
        try:
            if conversation is not None:
                ...
                from wycode.conversation import ConversationManager as CM
                conv = CM()
