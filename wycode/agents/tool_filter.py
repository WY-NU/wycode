...
def build_teammate_tools(
    ...
    from wycode.tools.send_message import SendMessageTool
    from wycode.tools.task_create import TaskCreateTool
    from wycode.tools.task_get import TaskGetTool
    from wycode.tools.task_list import TaskListTool
    from wycode.tools.task_update import TaskUpdateTool
...
def clone_registry_for_fork(parent_registry: ToolRegistry) -> ToolRegistry:
    ...
    from wycode.tools.agent_tool import FORK_QUERY_SOURCE
