...
PROJECT_AGENTS_DIR = ".wycode/agents"
USER_AGENTS_DIR = "~/.wycode/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("wycode.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from wycode.agents.parser import parse_frontmatter, _validate_agent_meta
