...
from wycode.skills.parser import SkillDef, substitute_arguments

if TYPE_CHECKING:
    from wycode.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from wycode.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
