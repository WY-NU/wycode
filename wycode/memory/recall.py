...
SELECTOR_SYSTEM_PROMPT = (
    "You are selecting memories that will be useful to WyCode as it processes "
    ...
    "WyCode as it processes the user's query (up to 5). Only include memories "
    ...
    "that are usage reference or API documentation for those tools (WyCode is "
