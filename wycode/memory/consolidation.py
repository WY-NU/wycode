...
from wycode.memory.auto_memory import ENTRYPOINT_NAME, MAX_ENTRYPOINT_LINES
from wycode.memory.session import SessionManager
...
class MemoryConsolidator:
    ...
    def __init__(
        ...
        *,
        ...
        self._mem_dir = os.path.join(work_dir, ".wycode", "memory")
        self._user_mem_dir = os.path.join(Path.home(), ".wycode", "memory")
    ...
    async def _do_consolidation(
        ...
        from wycode.permissions.checker import PermissionChecker
        from wycode.tools import ToolRegistry
        from wycode.tools.bash import BashTool
        from wycode.tools.edit_file import EditFileTool
        from wycode.tools.glob import GlobTool
        from wycode.tools.grep import GrepTool
        from wycode.tools.read_file import ReadFileTool
        from wycode.tools.write_file import WriteFileTool

        transcript_dir = os.path.join(self._work_dir, ".wycode", "sessions")
