...
from wycode.tools.base import Tool, ToolResult

if TYPE_CHECKING:
    from wycode.agent import Agent
    from wycode.agents.loader import AgentLoader
    from wycode.agents.parser import AgentDef
...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from wycode.agents.fork import ForkError, build_forked_messages
        from wycode.agents.parser import AgentDef
        from wycode.agents.tool_filter import clone_registry_for_fork, resolve_agent_tools
        from wycode.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from wycode.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from wycode.agents.fork import ForkError, build_forked_messages
        from wycode.agents.parser import AgentDef
        from wycode.agents.tool_filter import build_teammate_tools
        from wycode.agent import Agent as AgentClass
        from wycode.conversation import ConversationManager
        from wycode.permissions import (
            DangerousCommandDetector,
        ...
        from wycode.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from wycode.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from wycode.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from wycode.agents.parser import AgentDef
        from wycode.agents.tool_filter import resolve_agent_tools
        from wycode.agent import Agent as AgentClass
        from wycode.conversation import ConversationManager
        from wycode.permissions import (
            DangerousCommandDetector,
        ...
        from wycode.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from wycode.client import create_client
        from wycode.config import ProviderConfig
