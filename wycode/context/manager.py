...
from wycode.conversation import (
    ConversationManager,
    Message,
    ToolResultBlock,
    estimate_tokens,
)
from wycode.serialization import build_messages

# ---------------------------------------------------------------------------
# 常量
# ---------------------------------------------------------------------------

SINGLE_RESULT_CHAR_LIMIT = 50_000 # 单条结果
AGGREGATE_CHAR_LIMIT = 200_000 # 聚合结果
PREVIEW_CHARS = 2_000 # 预览
...
SESSION_SUBDIR = ".wycode/session/tool-results"
...
async def auto_compact(
    ...
    for attempt in range(max_retries):
        try:
            from wycode.tools.base import StreamEnd, StreamEvent, TextDelta
